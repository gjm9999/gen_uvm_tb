...
#RUN_OPTIONS += +UVM_OBJECTION_TRACE
ifeq ($(wave), on)
...
verdi:
	@verdi -simflow -dbdir $(SIM_PATH)/exec/simv.daidir -ssf $(SIM_PATH)/wave/*.fsdb &

clean:
	@-rm -rf $(SIM_PATH) ucli.key csrc vc_hdrs.h novas.conf  novas_dump.log  novas.rc verdiLog *.log *.rc stack.*
